...
router.get('/add-product', isAdmin, (req, res) => {
  ...
  Category.find({}).then(categories => { // theloume otan prosthetoume ena proion na prosthetoume kai tin katigoria tou
...
router.post('/add-product', (req, res) => {
  ...
  let imageFile = typeof req.files.image !== 'undefined' ? req.files.image.name : '';  // exoume prosvash sto req.files eksetias toy file upload module. to image einai to name tou input opou mpenei h eikona sti forma mas sto ejs
  ...
  if (errors) {
    ...
    Product.findOne({ slug: slug }).then(product => {
      ...
      if (product) {
        ...
        let product = new Product({ // save data to Product model
        ...
        product.save().then(result => {
          ...
          mkdirp('public/product-images/' + product._id, err => { // ftiaxnoume fakelo mesa sto product-images fakelo me onoma to id tou sigkekrimenou fakelou. mkdirp module
          ...
          if (imageFile !== '') { // !edw kati pezei
            let productImage = req.files.image;
            let path = 'public/product-images/' + product._id + '/' + imageFile;
...
router.post('/product-gallery/:id', (req, res) => {
  ...
  let thumbsPath = 'public/product-images/' + id + '/gallery/thumbs/' + productImage.name;
...
router.get('/delete-image/:image', isAdmin, (req, res) => {
  ...
  let originalImage = 'public/product-images/' + req.query.id + '/gallery/' + req.params.image;
  let thumbImage = 'public/product-images/' + req.query.id + '/gallery/thumbs/' + req.params.image;
